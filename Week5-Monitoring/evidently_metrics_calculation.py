...
drop table if exists evi_metrics;
create table evi_metrics(
	timestamp timestamp,
...
def calculate_metrics_postgresql(curr, i):
	...
	curr.execute(
		"insert into evi_metrics(timestamp, prediction_drift, num_drifted_columns, share_missing_values, quantile_values) values (%s, %s, %s, %s, %s)",
